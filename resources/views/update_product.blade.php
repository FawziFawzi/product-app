    ...
    <form class="form-horizontal" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="product_name" name="name" placeholder="PRODUCT NAME" class="form-control input-md" required="" type="text" value="{{ $product->name }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="product_name_fr" name="category" placeholder="PRODUCT Category" class="form-control input-md" required="" type="text" value="{{ $product->category }}">
